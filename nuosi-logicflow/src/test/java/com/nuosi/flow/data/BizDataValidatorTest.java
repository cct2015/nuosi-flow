 ...
 * @version v1.0.0
 */
public class BizDataValidatorTest {
    ...
    public void before() throws ParseException {
        ...
        BDataValidator stringValidator = new StringValidator().setMax(10);
        BDataValidator intValidator = new IntegerValidator().setMax(200).setMin(0);
        BDataValidator decimalValidator = new DecimalValidator().setPrecision(4).setScale(2)
        ...
        BDataValidator dateValidator = new DateValidator().setMin(startDate).setMax(endDate);
        ...
        BDataValidator datetimeValidator = new DatetimeValidator().setMin(startDatetime).setMax(endDatetime);

        // 注册User结构的业务对象
        BDataDefine userDefine = new BizDataDefine(bizName);
        userDefine.defineValidator("name", stringValidator);
        userDefine.defineValidator("age", intValidator);
        userDefine.defineValidator("height", decimalValidator);
        userDefine.defineValidator("birthday", dateValidator);
        userDefine.defineValidator("create_date", datetimeValidator);
