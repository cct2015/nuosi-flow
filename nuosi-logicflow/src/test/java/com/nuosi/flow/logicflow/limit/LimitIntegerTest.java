...
public class LimitIntegerTest {
    ...
    public void before() throws IOException {
        String[] flowConfigs = {
                "logicflow/limit/int/int_format_limit.xml",
                "logicflow/limit/int/int_min_limit.xml",
                "logicflow/limit/int/int_max_limit.xml",
                "logicflow/limit/int/int_less_limit.xml",
                "logicflow/limit/int/int_more_limit.xml",
                "logicflow/limit/int/int_equal_limit.xml",
                "logicflow/limit/int/int_unequal_limit.xml"
        };
